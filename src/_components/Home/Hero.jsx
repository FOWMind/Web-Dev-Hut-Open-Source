...
import HeroImage from 'src/_assets/hero-image.svg'
import HeroBg from 'src/_assets/hero-bg.svg'

import { Headline, Paragraph, SectionBg } from 'src/_components'

export const Hero = () => {
  return (
    <div className="pt-32 xl:pt-44 -mt-36 xl:-mt-44 lg:min-h-screen bg-gradient-to-br from-[#31109B] to-[#907EC8]">
      <SectionBg image={HeroBg} />
      ...
      <div className="max-w-screen-xl mx-auto px-5 py-10">
        <div className="w-full flex items-start relative z-10">
          ...
          <div className="w-full lg:block hidden">
            <img src={HeroImage?.src || HeroImage} alt="Hero image" />
          </div>
        </div>
      </div>
    </div>
